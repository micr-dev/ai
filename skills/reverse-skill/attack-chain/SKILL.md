---
name: attack-chain
description: Plan and coordinate multi-stage security assessment workflows across reconnaissance, exploitation, privilege escalation, lateral movement, persistence, and reporting. Use when the task needs attack-path orchestration, attack surface assessment, exploit-chain impact analysis, webshell next steps, red-team exercise planning, or cross-skill routing.
---
