---
name: mobile-reverse
description: Analyze and security-test Android APKs and iOS IPAs with static and dynamic reverse engineering workflows. Use for Frida or Objection instrumentation, SSL pinning bypass, root or jailbreak detection bypass, mobile cryptography extraction, OWASP MASTG testing, and non-root or non-jailbroken mobile app assessment.
---
