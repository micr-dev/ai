---
name: llm-security
description: Assess security of LLM applications and AI agents. Use for prompt injection, indirect injection through RAG or external content, tool-abuse testing, memory poisoning, model supply-chain review, agent authorization boundaries, system prompt leakage, and OWASP LLM or Agentic AI security workflows.
---
