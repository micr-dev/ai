---
name: reverse-skill
description: Route reverse engineering, CTF, APK, binary, JavaScript signing, browser automation, mobile, malware, supply-chain, and security analysis tasks to the correct specialized reverse-skill module. Use when a request involves reverse engineering, binary analysis, APK or IPA analysis, exploit-chain planning, security testing reports, front-end JavaScript reversing, malware analysis, or local reverse tooling.
---
