...
description: Assess software supply-chain security across dependencies, SBOMs, SCA, CI/CD pipelines, containers, build provenance, artifact signing, and vulnerability reachability. Use for dependency vulnerability scanning, open-source component review, container image analysis, build integrity checks, and supply-chain incident response.
---
