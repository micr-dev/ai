document.addEventListener('DOMContentLoaded', () => {
  ...
  const skillContentPaths = {
    ...
    'docs-generator': 'skills/reverse-skill/docs-generator/SKILL.md',
    'edr-bypass-re': 'skills/reverse-skill/edr-bypass-re/SKILL.md',
    'firmware-pentest': 'skills/reverse-skill/firmware-pentest/SKILL.md',
    'ida-reverse': 'skills/reverse-skill/ida-reverse/SKILL.md',
    'js-reverse': 'skills/reverse-skill/js-reverse/SKILL.md',
    'llm-security': 'skills/reverse-skill/llm-security/SKILL.md',
    'malware-analysis': 'skills/reverse-skill/malware-analysis/SKILL.md',
    'mobile-reverse': 'skills/reverse-skill/mobile-reverse/SKILL.md',
    'patch-diff-exploit': 'skills/reverse-skill/patch-diff-exploit/SKILL.md',
    'pentest-tools': 'skills/reverse-skill/pentest-tools/SKILL.md',
    'pwn-chain': 'skills/reverse-skill/pwn-chain/SKILL.md',
    'radare2': 'skills/reverse-skill/radare2/SKILL.md',
    'reverse-engineering': 'skills/reverse-skill/reverse-engineering/SKILL.md',
