document.addEventListener('DOMContentLoaded', () => {
  ...
  const skillContentPaths = {
    ...
    'reddit-research': 'skills/reddit-research/SKILL.md',
    'scandinavian-design': 'skills/scandinavian-design/SKILL.md',
    'skill-grooming': 'skills/skill-grooming/SKILL.md',
  ...
  function getSkillGithubUrl(skillId) {
    const externalSkillUrls = {
      ...
      'to-spec': 'https://github.com/mattpocock/skills/blob/main/skills/engineering/to-spec',
      'to-tickets': 'https://github.com/mattpocock/skills/blob/main/skills/engineering/to-tickets',
    ...
    'consolidate-test-suites': 'https://github.com/mattpocock/skills/tree/main/skills/engineering/consolidate-test-suites',
    ...
    'good-api-design': 'https://github.com/mattpocock/skills/tree/main/skills/engineering/good-api-design',
    'hard-cut': 'https://github.com/mattpocock/skills/tree/main/skills/engineering/hard-cut',
    'install-anti-slop': 'https://github.com/mattpocock/skills/tree/main/skills/engineering/install-anti-slop',
    'migrate-to-parallel': 'https://github.com/parallel-web/parallel-cli/tree/main/skills/migrate-to-parallel',
    'parallel-cli-setup': 'https://github.com/parallel-web/parallel-cli/tree/main/skills/parallel-cli-setup',
    'parallel-data-enrichment': 'https://github.com/parallel-web/parallel-cli/tree/main/skills/parallel-data-enrichment',
    'parallel-deep-research': 'https://github.com/parallel-web/parallel-cli/tree/main/skills/parallel-deep-research',
    'parallel-findall': 'https://github.com/parallel-web/parallel-cli/tree/main/skills/parallel-findall',
    'parallel-memory': 'https://github.com/parallel-web/parallel-cli/tree/main/skills/parallel-memory',
    'parallel-monitor': 'https://github.com/parallel-web/parallel-cli/tree/main/skills/parallel-monitor',
    'parallel-web-extract': 'https://github.com/parallel-web/parallel-cli/tree/main/skills/parallel-web-extract',
    'parallel-web-search': 'https://github.com/parallel-web/parallel-cli/tree/main/skills/parallel-web-search',
    'result': 'https://github.com/parallel-web/parallel-cli/tree/main/skills/result',
    'root-cause-finder': 'https://github.com/av/skills/tree/master/root-cause-finder',
    ...
    'status': 'https://github.com/parallel-web/parallel-cli/tree/main/skills/status',
    'variant': 'https://github.com/emilkowalski/skills/tree/main/skills/variant',
    'vercel-sandbox': 'https://github.com/vercel-labs/agent-browser/tree/main/skills/vercel-sandbox',
    'writing-for-agents': 'https://github.com/mattpocock/skills/tree/main/skills/engineering/writing-for-agents',
